...
<div class="col-md-12">
    <div class="card card-secondary">
      ...
      <div class="card-body">
        ...
        <form role="form" action="{{ route('player.update',$player->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 select2-hidden-accessible @error('club') is-invalid @enderror" name="club"  style="width: 100%;">
                            @foreach ($clubs as $club)
                                ...
                                @endif
                            <option @if($club->id == $player->club_id) selected="selected" @endif value="{{$club->id}}" >{{$club->name}}</option>
                            @endforeach
                        </select>
                        @error('club')
