...
<div class="col-md-12">
    <div class="card card-secondary">
      ...
      <!-- /.card-header -->
      <div class="card-body">
            <form role="form" action="{{ route('player.store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="box-body">
                      <div class="offset-lg-3 col-lg-6">
                               ...
                               <div class="card text-center">
                                   <div class="card-body">
                                       <div class="profile-img">
                                            ...
                                            @endphp
                                           <img src="{{ $image }}" id="profile-pic" width="150px" height="150px">
                                       </div>
                                ...
                                <div class="form-group">
                                <label>{{ __('Club') }}</label>
                                <select class="form-control select2 select2-hidden-accessible" name="club"  style="width: 100%;">
                                    @foreach ($clubs as $club)
                                        @if ($loop->first)
                                            <option value=""  selected>{{ __('All CLubs') }}</option> 
                                        @endif
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" name="name" placeholder="player Name" value="{{ old('name') }}">
                          </div>
                          ...
                          <div class="form-group">
                          <a href='{{ route('player.index') }}' class="btn btn-warning">Back</a>
